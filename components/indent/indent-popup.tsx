...
const IndentPopUp: React.FC<JobCardPopUPProps> = ({ isOpen, onClose }) => {
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid w-full items-center gap-1.5">
                  ...
                  <Input
                    id="driver"
                    defaultValue="Md. Shaidul Merdha"
                  />
                </div>
                ...
                <div className="grid w-full items-center gap-1.5">
                  <Label htmlFor="approve">1st Approve</Label>
                  <RadioGroup
                    value={approved}

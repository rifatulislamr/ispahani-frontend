...
import { CalendarIcon, FolderOpen, FuelIcon, WrenchIcon } from 'lucide-react'
...
const ExpenseInfoRepairAndMaintenancePopUp: React.FC<
  VehicleInformationPopUPProps
> = ({ isOpen, onClose }) => {
      ...
      <div className="flex flex-col w-full max-w-4xl bg-white border border-gray-300 max-h-[90vh] overflow-y-auto rounded-lg shadow-lg">
        <div className="p-2 flex justify-between items-center sticky top-0 z-10">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <WrenchIcon className="text-amber-600" />
...
export default ExpenseInfoRepairAndMaintenancePopUp

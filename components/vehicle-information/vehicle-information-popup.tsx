...
const VehicleInformationPopUP = () => {
  return (
    <div className="flex flex-col w-full max-w-6xl mx-auto border border-gray-300">
      {/* Header */}
      <div className="bg-[#40BFC1] p-2 flex flex-col items-center">
       
        <h2 className="text-[#800000] text-3xl font-bold mt-4 underline">
          Vehicle Information
        </h2>
      </div>
      ...
      <div className="bg-gray-400 p-2">
        <div className="grid grid-cols-4 gap-x-1 gap-y-1 text-xs">
          ...
          {/* Row 8 */}
          <FormField label="Present Driver" defaultValue="Mr. Monir Hossain" />
          <div className="flex flex-col">
          ...
          {/* Row 17 */}
          <FormField label="Last Fitness Pay Date" defaultValue="25/12/2012" />
          <FormField label="Last Fitness Pay Date" defaultValue="25/12/2013" />
          <div className="col-span-2"></div>
